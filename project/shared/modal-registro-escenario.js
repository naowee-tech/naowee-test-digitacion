  ...
  return `
    <div class="reg-modal" role="document">
      ...
      <div class="reg-modal__body">
        ...
        <!-- Catastral duplicate error -->
        <div class="naowee-message naowee-message--negative" id="regCatastralDupMsg" hidden>
          <div class="naowee-message__header">
            ...
            <div class="naowee-message__title">Error de validación</div>
          </div>
          <p class="naowee-message__text">
            No se puede hacer el registro porque ya existe un escenario con el mismo número de registro catastral. <strong>Modifica los datos para continuar.</strong>
          </p>
        </div>
...
export async function openRegistroEscenarioModal({ proyectoId, onCompleted } = {}) {
  ...
  const dupMsg = overlay.querySelector('#regCatastralDupMsg');
